...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        updateFormInputs: function () {
            ...
            var inputVal = this.startDate.format(this.locale.format);

            if (!this.singleDatePicker) {
                inputVal += ' - ' + this.endDate.format(this.locale.format);
            }

            this.container.find('input[name=daterangepicker_start]').val(inputVal);
        ...
        showCalendar: function () {
            ...
            if (this.singleDatePicker) {
                this.container.addClass('single-date-picker');
            } else {
                this.container.removeClass('single-date-picker');
            }
      ...
      /*      //ignore mouse movements while an above-calendar text input has focus
        ...
        clickRange: function (e) {
            ...
            if (label == this.locale.specificDayLabel) {
                this.container.find('.ranges li').removeClass('active');
                this.container.find('.ranges li.calendar-specific-day-selector').addClass('active');
      ...
      /*      if (this.endDate) {
            ...
            if (!this.endDate) {
                this.container.find('.calendar td').each(function (index, el) {
                    ...
                    var dt = leftCalendar.calendar[row][col];
